...
async function createIntroOutroVideo(){
    ...
    basic.downloadVideo(url,"introoutro.mp4");
    console.log("Completed: Video downloaded with name introoutro.mp4 complete");
    }

  createIntroOutroVideo()
